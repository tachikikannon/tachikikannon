    ...
    <>
      ...
      <main className="pt-16">
        ...
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-12">
          <section>
            <h2 className="text-xl font-serif text-onsenji pl-3 border-l-4 border-[#7ec8a4] mb-4">数珠づくりとは</h2>
          ...
          <section className="bg-onsenji/5 -mx-4 px-4 py-10 md:-mx-8 md:px-8 rounded-2xl">
            <h2 className="text-xl font-serif text-onsenji pl-3 border-l-4 border-[#7ec8a4] mb-4">珠の素材について</h2>
          ...
          <div className="bg-onsenji rounded-2xl p-8 text-center text-white">
            <p className="font-serif text-xl mb-2">数珠づくり体験のご予約・お問い合わせ</p>
