  ...
  if (status === 'done') return (
    <main className="min-h-screen pt-24 flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        ...
        <h1 className="text-2xl font-serif text-onsenji mb-3">申請を受け付けました</h1>
  ...
  return (
    <main className="pt-24 pb-16 px-4">
      <div className="max-w-lg mx-auto">
        <nav className="text-xs text-gray-400 mb-6"><Link href="/onsenji">ホーム</Link> &gt; 各種申請のお問い合わせ</nav>
        <h1 className="text-3xl font-serif text-onsenji mb-1">各種申請のお問い合わせ</h1>
        ...
        <div className="mb-8 p-5 bg-onsenji/5 rounded-xl flex flex-col sm:flex-row items-center gap-4">
          <div className="flex-1">
            <p className="font-serif text-onsenji text-sm mb-1">貸出用写真をお探しですか？</p>
        ...
        <div className="mt-10 p-5 bg-onsenji/5 rounded-xl text-sm text-gray-600">
          <p className="font-medium text-onsenji mb-2">お電話でのお問い合わせ</p>
