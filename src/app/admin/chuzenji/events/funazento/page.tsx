...
const FIELDS = [
  ...
  { key: 'funazento_about', label: '行事について（説明文）', multiline: true, defaultValue: '船禅頂（ふなぜんじょう）は、日光山を開いた勝道上人（737〜817）が中禅寺湖を舟で渡り、湖上から霊峰・男体山を遙拝したという故事に由来する伝統行事です。', translatable: true },
  ...
  { key: 'funazento_heading_map', label: '「船禅頂ルール・ルート図」見出し', defaultValue: '船禅頂ルール・ルート図', translatable: true },
