...
const SECTIONS: Section[] = [
  {
    ...
    fields: [
      ...
      { key: 'onsenji_hero_sub',   label: 'ヒーロー サブコピー', multiline: true, defaultValue: '世界遺産・日光山輪王寺の別院\n \n薬師瑠璃光如来のご加護と、大地から湧く温泉の癒し', translatable: true },
      ...
      { key: 'onsenji_access_car',  label: 'アクセス お車での説明', multiline: true, defaultValue: '日光宇都宮道路 日光ICより約60分\n境内に駐車場あり', translatable: true },
      { key: 'onsenji_access_bus',  label: 'アクセス バスでの説明', multiline: true, defaultValue: '東武日光駅・JR日光駅よりバスで80分「湯元温泉」バス停下車、徒歩約2分', translatable: true },
    ],
  },
  {
    section: '温泉寺の歴史',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'onsenji_grounds_onsen_text', label: '薬師の湯 説明文', multiline: true, defaultValue: '境内には（本年度は4月11日に開湯）「薬師の湯」があります。泉質は含硫黄‐カルシウム・ナトリウム‐硫酸塩・炭酸水素塩泉（泉温71.4℃）の完全かけ流し。加水すると乳白色に変わる神秘的な湯は、参拝者に開放されています。薬師如来の御加護とともに心身を清めていただけます。', translatable: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'onsenji_onsen_about', label: '薬師の湯について（説明文）', multiline: true, defaultValue: '「薬師の湯」は延暦7年（788年）の開創以来、薬師瑠璃光如来のご加護のもと守り続けられてきた霊泉です。本年度は4月11日に参拝者への開放が始まりました。薬師如来の御加護と温泉の癒しを同時にいただける、温泉寺ならではの体験です。', translatable: true },
      ...
      { key: 'onsenji_onsen_fee_note', label: '料金', defaultValue: '入湯料　大人500円・小中学生300円', translatable: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'onsenji_onsen_status_reception_closed_label', label: '受付終了間際（終了1時間前〜終了時刻）の表示文言', defaultValue: '本日の入浴の受付は終了しました', translatable: true },
      ...
      { key: 'onsenji_onsen_status_close_time', label: '入浴終了時刻（24時間表記 例: 16:00。終了1時間前になると自動で受付終了の表示文言に切り替わり、この時刻を過ぎると時間外の表示文言に切り替わります）', defaultValue: '16:00' },
  ...
  },
  {
    ...
    fields: [
      { key: 'onsenji_events_subtitle', label: '見出し（ヒーロー サブタイトル）', defaultValue: '温泉寺の法要・行事のご案内', translatable: true },
      {
        ...
        defaultValue: J([
          { month: '8月', date: '8月8日', time: '午前11時〜', name: '薬師講大祭・採灯大護摩供', desc: '薬師堂にてご本尊・薬師瑠璃光如来への法要を執り行います。又、湯の湖畔では、山伏によって採灯大護摩供が行われます。写経などが御本尊に奉じられ、護摩の炎で焚き上げられる、温泉寺最大の法要です。' },
          { month: '1月', date: '1月下旬', time: '午前11時〜', name: '温泉寺 節分大祭', desc: '新年の邪気を払い、福を招く節分の法要です。参拝者の一年の健康と幸福をお祈りします。' },
        ]),
        translatable: true,
        defaultValueEn: J([
          { month: 'August', date: 'August 8', time: 'From 11:00 AM', name: 'Yakushiko Grand Festival & Saito Goma Fire Ritual', desc: 'A memorial service to the principal image, Yakushi Rurikou Nyorai, is held at the Yakushi Hall. Mountain ascetics (yamabushi) also perform the Saito Goma fire ritual on the shore of Lake Yunoko. Copied sutras and other offerings are presented to the principal image and burned in the goma flames — the largest ceremony of the year at Onsenji.' },
          { month: 'January', date: 'Late January', time: 'From 11:00 AM', name: 'Onsenji Setsubun Grand Festival', desc: 'A Setsubun ceremony to drive away misfortune and welcome good luck for the new year, praying for the health and happiness of all visitors in the year ahead.' },
        ]),
      },
    ],
  },
