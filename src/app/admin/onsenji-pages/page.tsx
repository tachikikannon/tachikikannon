...
const SECTIONS: Section[] = [
  {
    ...
    fields: [
      ...
      {
        key: 'onsenji_news', label: 'お知らせ一覧', type: 'list',
  ...
  },
  {
    ...
    fields: [
      { key: 'onsenji_history_subtitle', label: '見出し（サブタイトル）', defaultValue: '日光山温泉寺の由緒と縁起' },
      { key: 'onsenji_history_heading_founding', label: '「創建の由来」見出し', defaultValue: '創建の由来' },
      ...
      { key: 'onsenji_history_heading_timeline', label: '「歴史の流れ」見出し', defaultValue: '歴史の流れ' },
      {
      ...
      { key: 'onsenji_history_heading_honzon', label: '「ご本尊」見出し', defaultValue: 'ご本尊・薬師如来について' },
      ...
      { key: 'onsenji_history_heading_bando', label: '「霊場としての温泉寺」見出し', defaultValue: '霊場としての温泉寺' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'onsenji_grounds_heading_map', label: '「境内マップ・主な見どころ」見出し', defaultValue: '境内マップ・主な見どころ' },
      { key: 'onsenji_grounds_map_hint', label: '地図の操作案内文', defaultValue: '地図上のピンをクリックすると各スポットの詳細が見られます' },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'onsenji_shakyou_heading_contents', label: '「体験内容」見出し', defaultValue: '体験内容' },
      { key: 'onsenji_shakyou_content_title', label: '体験内容 タイトル', defaultValue: '薬師経' },
      { key: 'onsenji_shakyou_content_desc', label: '体験内容 説明文', multiline: true, defaultValue: 'ご本尊・薬師如来に縁の深い薬師経をお写しいただきます。お写しいただいた方には特別御朱印をお授けします。' },
  ...
  },
  {
    ...
    fields: [
      { key: 'onsenji_shabutu_subtitle', label: '見出し（ヒーロー サブタイトル）', defaultValue: '仏様のお姿を一筆一筆、心を込めてお描きいただきます' },
      { key: 'onsenji_shabutu_heading_about', label: '「写仏とは」見出し', defaultValue: '写仏とは' },
      ...
      { key: 'onsenji_shabutu_about_p2', label: '写仏とは（段落2）', multiline: true, defaultValue: '温泉寺の写仏体験では、ご本尊・薬師如来のお姿をお描きいただきます。完成した写仏は記念にお持ち帰りいただけます。絵が苦手な方でも、下絵に沿って描くためどなたでもお楽しみいただけます。' },
      { key: 'onsenji_shabutu_heading_contents', label: '「体験内容」見出し', defaultValue: '体験内容' },
      { key: 'onsenji_shabutu_content_title', label: '体験内容 タイトル', defaultValue: '薬師如来' },
      { key: 'onsenji_shabutu_content_desc', label: '体験内容 説明文', multiline: true, defaultValue: '下絵に沿って、ご本尊・薬師如来のお姿をお描きいただきます。完成後は特別御朱印とセットでお授けします。' },
      { key: 'onsenji_shabutu_heading_fees', label: '「料金・所要時間」見出し', defaultValue: '料金・所要時間' },
      { key: 'onsenji_shabutu_fee',  label: '体験料', defaultValue: '1,000円（御朱印込み）' },
      { key: 'onsenji_shabutu_time', label: '所要時間', defaultValue: '約30〜60分（個人差があります）' },
      { key: 'onsenji_shabutu_target', label: '対象', defaultValue: 'どなたでも（絵が苦手な方も歓迎）' },
      { key: 'onsenji_shabutu_place', label: '受付場所', defaultValue: '寺務所 体験受付窓口' },
      { key: 'onsenji_shabutu_hours', label: '受付時間', defaultValue: '拝観時間内（閉門1時間前まで）' },
      { key: 'onsenji_shabutu_heading_flow', label: '「体験の流れ」見出し', defaultValue: '体験の流れ' },
      {
      ...
      { key: 'onsenji_shabutu_cta_heading', label: 'CTA見出し', defaultValue: '写仏体験のご予約・お問い合わせ' },
