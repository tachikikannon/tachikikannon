...
const SECTIONS: Section[] = [
  {
    ...
    fields: [
      ...
      { key: 'onsenji_top_reveal_heading', label: 'スクロールリビール キャッチコピー（白背景から文字が浮かび、写真が現れる演出／改行可）', multiline: true, defaultValue: '山は崩れても、\n祈りは残った。', translatable: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'onsenji_onsen_status_open_label', label: '営業中の表示文言', defaultValue: '温泉入れます', translatable: true },
      { key: 'onsenji_onsen_status_closed_time_label', label: '時間外の表示文言', defaultValue: '温泉入れません', translatable: true },
      ...
      { key: 'onsenji_onsen_status_note', label: '入浴時間の下に表示する補足文言', defaultValue: '※浴槽が小さいため、満員の場合はお待たせすることがございます。', translatable: true },
      {
