        ...
        <div className="bg-white rounded-xl shadow p-6 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-3 border-t border-gray-100 space-y-4">
              ...
              <div>
                <label className="admin-label">概要（英語）</label>
              ...
              <div>
                ...
                <textarea className="admin-input min-h-[180px]" value={editing.body_en ?? ''} onChange={e => setEditing({...editing, body_en: e.target.value})} />
              </div>
            </div>
