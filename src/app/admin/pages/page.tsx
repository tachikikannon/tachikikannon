...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'funazento_info_fee', label: '参加費（カード表示）', defaultValue: '5,000円（小中学生以下4,000円）', translatable: true, defaultValueEn: '¥5,000 (¥4,000 for students and younger)' },
      ...
      { key: 'funazento_heading_notes', label: '「ご参加にあたって」見出し', defaultValue: 'ご参加にあたって', translatable: true },
      {
        ...
        defaultValue: J([
          ...
          { text: '参加費は大人5,000円・小中学生以下4,000円です。当日ご参加されない場合も、御札代として4,000円を頂戴いたします。お支払いは当日・現地にてお受けいたします。' },
        ...
        defaultValueEn: J([
          ...
          { text: 'The participation fee is ¥5,000 for adults and ¥4,000 for elementary/junior high school students and younger. Even if you do not join in person on the day, a fee of ¥4,000 applies for the ofuda talisman. Payment is accepted on the day, on site.' },
      ...
      { key: 'funazento_apply_notice_fee', label: '申込フォーム 注意事項（💰 参加費）', multiline: true, defaultValue: '参加費は大人5,000円・小中学生以下4,000円です。当日ご参加されない場合も、御札代として4,000円を頂戴いたします。', translatable: true, defaultValueEn: 'The participation fee is ¥5,000 for adults and ¥4,000 for elementary/junior high school students and younger. Even if you do not join in person on the day, a fee of ¥4,000 applies for the ofuda talisman.' },
