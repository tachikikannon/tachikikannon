...
const DEFAULT_SPOTS = [
  ...
  { name: '札所・朱印所', image: '/images/hudasyo.png', desc: '御朱印・お守り・各種授与品はこちらでお受けいただけます。坂東三十三観音霊場の第十八番札所です。' },
  ...
  { name: '立木観音堂（本堂）', image: '/images/main2.png', desc: '勝道上人が桂の立木に直接刻んだと伝わる千手観世音菩薩をお祀りする本堂。根を張ったままの立木が今も残ります。' },
