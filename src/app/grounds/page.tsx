        ...
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-14">
          ...
          <section>
            ...
            <p className="text-sm text-gray-700 leading-loose">
              五大堂の大窓からは、中禅寺湖と男体山を一望することができます。四季折々の景色は訪れる人々を魅了し、特に紅葉の季節には多くの参拝者が訪れます。また、天井に描かれた龍の大墨絵も必見です。
            </p>
          </section>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4">
            <Link href="/about" className="flex items-center justify-center p-4 bg-white rounded-xl border shadow-sm hover:bg-navy hover:text-white transition-all text-sm font-medium text-navy">
              拝観時間・料金
            </Link>
            <Link href="/history" className="flex items-center justify-center p-4 bg-white rounded-xl border shadow-sm hover:bg-navy hover:text-white transition-all text-sm font-medium text-navy">
              立木観音の歴史
            </Link>
          </div>
