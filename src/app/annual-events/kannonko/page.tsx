...
export default function KannonkoPage() {
  return (
    <>
      <Header />
        ...
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-14">
          ...
          <section>
            ...
            <p className="text-sm text-gray-700 leading-loose">
              毎年6月18日、日光山中禅寺 立木観音では、ご信徒・一般参拝者の皆様をお迎えして年に一度の大法要を執り行います。観音講・大護摩供・地蔵流しと三つの行事が続き、中禅寺湖の豊かな自然のなかで千二百余年の祈りが受け継がれます。
            </p>
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                '参列は自由です。事前のお申し込みは不要ですが、お願い事の御札をご希望の方は申し込みフォームよりお申し込みください。',
                '動きやすい服装でお越しください。中禅寺湖周辺は天候が変わりやすいため、羽織るものをお持ちいただくことをお勧めします。',
                'お支払いは当日・現地にてお受けいたします。',
                '詳細・変更がある場合は当サイトにてお知らせいたします。',
              ].map((text, i) => (
