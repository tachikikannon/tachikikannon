        ...
        <div className="max-w-3xl mx-auto px-4 py-12 space-y-14">
          ...
          <section>
            ...
            <div className="prose prose-sm max-w-none text-gray-700 leading-loose space-y-4">
              <p>
                日光山中禅寺は、784年（延暦3年）、勝道上人によって開かれました。勝道上人は日光山を開いた高僧であり、幾多の困難を乗り越えながら男体山に登頂し、山頂で大日如来を感得したとされています。
              </p>
              <p>
                中禅寺湖のほとりに建てられた本堂には、上人が湖畔に立つ桂の立木に直接刻んだと伝わる千手観世音菩薩が祀られています。木を切り倒すことなく、立ったままの木に彫り上げたことから「立木観音」と呼ばれ、今日まで人々の信仰を集めてきました。
              </p>
            </div>
          </section>
            ...
            <ol className="relative border-l-2 border-gold ml-4 space-y-8">
              {[
                ...
                <li key={i} className="pl-6 relative">
                  <div className="absolute -left-[19px] top-0 w-9 h-9 rounded-full bg-navy text-white flex items-center justify-center text-xs font-bold">
                    {i + 1}
                  </div>
          ...
          <section>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-gold">
              <p className="text-sm text-gray-700 leading-loose">
                ご本尊の千手観世音菩薩は、高さ約6メートルに及ぶ大きな仏様です。勝道上人が湖畔の桂の立木に直接刻んだとされ、木は今も根を張ったまま祀られています。千の手で人々のあらゆる願いを救い、千の眼で衆生の苦しみを見守るとされる観音様は、縁結び・病気平癒・学業成就など様々なご利益があるとされています。
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="w-10 h-0.5 bg-gold mb-6" />
            <p className="text-sm text-gray-700 leading-loose">
              中禅寺立木観音は、関東・東北一円にわたる坂東三十三観音霊場の第十八番札所に数えられています。多くの巡礼者がこの地を訪れ、千手観世音菩薩に手を合わせてきました。
            </p>
          </section>

          {/* 関連リンク */}
          <div className="grid grid-cols-2 gap-4 pt-4">
            <Link href="/about" className="flex items-center justify-center gap-2 p-4 bg-white rounded-xl border shadow-sm hover:bg-navy hover:text-white transition-all group text-sm font-medium text-navy group-hover:text-white">
              参拝について
            </Link>
            <Link href="/about#map" className="flex items-center justify-center gap-2 p-4 bg-white rounded-xl border shadow-sm hover:bg-navy hover:text-white transition-all group text-sm font-medium text-navy group-hover:text-white">
              境内のご案内
            </Link>
          </div>
