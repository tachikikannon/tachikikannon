...
const DEFAULTS: Record<string, string> = {
  ...
  grounds_godaido_text: '五大堂の大窓からは、中禅寺湖と男体山を一望することができます。四季折々の景色は訪れる人々を魅了し、特に紅葉の季節には多くの参拝者が訪れます。',
  grounds_godaido_text_en: 'From the large windows of Godaido Hall, visitors can enjoy sweeping views of Lake Chuzenji and Mount Nantai. The scenery changes beautifully with the seasons, and the autumn foliage is especially popular with visitors and worshippers.',
