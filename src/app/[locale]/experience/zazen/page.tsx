...
const DEFAULTS: Record<string, string> = {
  ...
  zazen_about_p1: '坐禅とは、静かに座り呼吸を整えながら心を調える、禅宗の伝統的な修行法です。姿勢と呼吸を整えることで、日々の雑念から離れ、静かなひとときを過ごすことができます。',
  zazen_about_p1_en: 'Zazen is a traditional Zen Buddhist practice of sitting quietly and settling the mind through breath and posture. By steadying your breath and body, you can step away from daily distractions and spend a quiet moment of stillness.',
  ...
  zazen_hours_peak_en: 'April–October: 1:00 PM–3:00 PM (every 30 min)',
  zazen_hours_shoulder: '3月・11月：13:00〜14:00（30分刻み）',
  zazen_hours_shoulder_en: 'March, November: 1:00 PM–2:00 PM (every 30 min)',
  zazen_hours_winter: '12月〜2月：13:00（1枠のみ）',
  zazen_hours_winter_en: 'December–February: 1:00 PM only (single slot)',
