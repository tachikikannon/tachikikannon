...
const DEFAULTS: Record<string, string> = {
  ...
  onsenji_onsen_about_en: '"Yakushi-no-Yu" is a sacred spring that has been protected under the guardianship of Yakushi Nyorai since the temple\'s founding in Enryaku 7 (788 CE). It was opened to visitors on April 11, 2026. It is a uniquely Onsenji experience — receiving both the protection of Yakushi Nyorai and the healing of the hot spring at once.',
