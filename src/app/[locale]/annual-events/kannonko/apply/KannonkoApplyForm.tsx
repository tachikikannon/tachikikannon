...
type Applicant = { key: number; name: string; nameKana: string; address: string; wish1: string; wish2: string; paymentMethod: PaymentMethod; shipMode: ShipMode }
...
const emptyApplicant = (): Applicant => ({ key: applicantKeySeq++, name: '', nameKana: '', address: '', wish1: '', wish2: '', paymentMethod: 'onsite', shipMode: 'same' })
            ...
            <div className="space-y-4">
              {applicants.map((a, i) => (
                <div key={a.key} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="mb-3">
                    <PaymentMethodBlock t={t} method={a.paymentMethod} onChange={m => setApplicant(a.key, 'paymentMethod', m)} />
                    {a.paymentMethod === 'cod' && (
                      <div className="mt-3">
