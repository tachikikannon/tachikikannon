...
export const NOTICE_DEFAULTS: Record<string, string> = {
  ...
  funazento_apply_notice_fee: '参加費は大人5,000円・小中学生以下4,000円です。当日ご参加されない場合も、御札代として4,000円を頂戴いたします。',
  funazento_apply_notice_fee_en: 'The participation fee is ¥5,000 for adults and ¥4,000 for elementary/junior high school students and younger. Even if you do not join in person on the day, a fee of ¥4,000 applies for the ofuda talisman.',
